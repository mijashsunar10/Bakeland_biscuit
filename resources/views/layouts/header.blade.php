    ...
    <div class="mx-auto px-0 xl:px-8">
        <div class="flex justify-between h-22 items-center">
            ...
            <div class="flex items-center">
                <img src="{{asset('images/logo.png')}}" alt="Logo" class="logo-img xxs:h-16 xms:h-20 xl:h-32 xl:w-48 h-full w-full sm:ml-10 mr-3 transition-all duration-300">
        ...
        <div class="relative z-10 h-full">
            <div class="flex justify-between items-center p-4 border-b border-gray-700">
                <div class="flex items-center space-x-3">
                    <span>
                        <img src="{{ asset('images/logo.png') }}" alt="Logo" class="h-20 w-40 rounded-full">
                    </span>
                </div>
            ...
            <ul class="mt-4 space-y-2">
                ...
                {{-- <li>
                 ...
                 --}}
                <li>
                    <a href="" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold" style="color: #FFF8E1 !important;">Menu</a>
                </li>
                
                <li>
                    <a href="" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold" style="color: #FFF8E1 !important;">Alumni</a>
                </li>
                
                <li>
                    <a href="" class="block px-4 py-2 text-lg text-[#FFF8E1] font-semibold" style="color: #FFF8E1 !important;">FAQs</a>
                </li>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function setScrolledState() {
        ...
        logoImg.classList.remove("xl:h-32", "xl:w-48", "h-full", "w-full", "ml-10");
    ...
    function setUnscrolledState() {
        ...
        logoImg.classList.add("xl:h-32", "xl:w-48", "h-full", "w-full", "ml-10");
